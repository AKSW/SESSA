...
/**
 * Interface for processing queries and getting the n-gram hierarchy
 * before they are given to SESSA.
 * @author Simon Bordewisch
 */
public interface QueryProcessingInterface {

  /**
   * Used to process the string in a meaningful way and
   * creating a n-gram hiearchy.
