package org.lucene46.util.automaton;
...
final class DaciukMihovAutomatonBuilder {
   ...
   */
  private static org.lucene46.util.automaton.State convert(State s,
      IdentityHashMap<State,org.lucene46.util.automaton.State> visited) {
	  org.lucene46.util.automaton.State converted = visited.get(s);
    if (converted != null) return converted;
    
    converted = new org.lucene46.util.automaton.State();
  ...
  public static Automaton build(Collection<BytesRef> input) {
    ...
    a.initial = convert(
        builder.complete(), 
        new IdentityHashMap<State,org.lucene46.util.automaton.State>());
